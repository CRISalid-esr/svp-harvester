...
<div class="input-group mt-3 mb-3" id="add-identifier-control">
                    <div style="width: max-content;">
                        <select class="form-select rounded-end-0 identifier-control-select" aria-label="Example select with button addon" id="add-identifier-control-select">
                    ...
                    <input type="text" class="form-control rounded-0 identifier-control-input" id="add-identifier-control-input">
