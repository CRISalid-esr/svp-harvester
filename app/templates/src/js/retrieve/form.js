...
class Form {
    constructor(env, rootElement) {
        ...
        this.handleFetchEnhancementsToggle();
    ...
    handleFetchEnhancementsToggle() {
        this.fetchEnhancementsToggle = this.formElement.querySelector(
            "#fetch-enhancements-toggle"
        );
    }
    ...
    handleSubmit(event) {
        ...
        const entitySubmitEvent = new CustomEvent("entity_submit", {
            detail: {
                ...
                fetchEnhancements: this.fetchEnhancementsToggle.checked,
            },
        });
