class SessionStorage {
    ...
    fillForm() {
        this.KEYS_IDENTIFIER.forEach(key => {
            ...
            if (value) {
                this.form.addIdentifierField({ identifierType: key, identifierValue: value })
            }
        });
        if (this.getItem(this.KEY_NAME)) {
            this.form.formElement.querySelector("#name-field-input").value = (this.getItem(this.KEY_NAME));
        }
