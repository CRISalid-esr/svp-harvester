...
class ScanrQualitiesConverter:
    ...
    ROLES_MAPPING = {
        ...
        "journal-article": Contribution.Role.UNKNOWN,
        ...
        "other": Contribution.Role.UNKNOWN,
        ...
        "preprint": Contribution.Role.UNKNOWN,
